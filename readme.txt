...
Now you can create custom profiles on your WordPress site with custom profile fields, front-end registrations and profile listing pages.
...
Ultimate Profile Builder by CMSHelpLive uses responsive layout and can snug inside your current WordPress template easily. Default theme is light, clean and professional, and will not look out of place on any site. Wherever possible HTML5 and CSS3 are used.
...
* Assign custom fields to User Groups
* Preinstalled Themes
* Helpdesk Support
