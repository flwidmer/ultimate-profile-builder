...
/*Controls saving process of options in dashboard settings. This file is subordinate to upboption.php*/
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(isset($_REQUEST['blackwhiteimage']))
		{
			mytable_add_option( 'upb_blackwhiteimage', $_REQUEST['blackwhiteimage']);
		}
	...
	if(isset($_REQUEST['RegCustomSubmit']))
	{
		...
		if($_REQUEST['directoryshowhide']=="") $_REQUEST['directoryshowhide']='no';
		if($_REQUEST['wooproductshowhide']=="") $_REQUEST['wooproductshowhide']='no';
		if($_REQUEST['ecoproductshowhide']=="") $_REQUEST['ecoproductshowhide']='no';
		if($_REQUEST['fourmshowhide']=="") $_REQUEST['fourmshowhide']='no';
		if($_REQUEST['topicshowhide']=="") $_REQUEST['topicshowhide']='no';
		if($_REQUEST['replieshowhide']=="") $_REQUEST['replieshowhide']='no';
		if($_REQUEST['favouriteshowhide']=="") $_REQUEST['favouriteshowhide']='no';
		if($_REQUEST['subscriptionshowhide']=="") $_REQUEST['subscriptionshowhide']='no';
		...
		mytable_add_option( 'upb_directoryshowhide', $_REQUEST['directoryshowhide']);
		mytable_add_option( 'upb_woo_productshowhide', $_REQUEST['wooproductshowhide']);
		mytable_add_option( 'upb_eco_productshowhide', $_REQUEST['ecoproductshowhide']);
		mytable_add_option( 'upb_fourmshowhide', $_REQUEST['fourmshowhide']);
		mytable_add_option( 'upb_topicshowhide', $_REQUEST['topicshowhide']);
		mytable_add_option( 'upb_replieshowhide', $_REQUEST['replieshowhide']);
		mytable_add_option( 'upb_favouriteshowhide', $_REQUEST['favouriteshowhide']);
		mytable_add_option( 'upb_subscriptionshowhide', $_REQUEST['subscriptionshowhide']);
	...
	if(isset($_REQUEST['personalization']))
	{
		...
		mytable_add_option( 'upb_welcome_email_subject', $_REQUEST['welcomeSubject']);
		mytable_add_option( 'upb_welcome_email_message', $_REQUEST['RegWelcomeMessage']);
