...
?>
        ...
        <p id="requirefield">
          ...
          <input type="checkbox" name="field_require" id="field_require" value="1" style="width:auto;"/>
        </p>
        <p id="readonlyfield">
          <label for="field_readonly">Is Read Only</label>
          <input type="checkbox" name="field_readonly" id="field_readonly" value="1" style="width:auto;" />
        </p>
        <p id="registrationformfield">
          <label for="field_registration">Show in Registration Form</label>
          <input type="checkbox" name="field_registration" id="field_registration" value="1" style="width:auto;" />
        </p>
