...
{?>
        ...
        <p id="requirefield">
          <label for="field_require">Is Required</label>
          <input type="checkbox" name="field_require" id="field_require" value="1" style="width:auto;" <?php if($row->Require==1)echo 'checked';?> />
        </p>
        <p id="readonlyfield">
          <label for="field_rules">Is ReadOnly</label>
          <input type="checkbox" name="field_readonly" id="field_readonly" value="1" style="width:auto;" <?php if($row->Readonly==1)echo 'checked';?> />
        </p>
        <p id="registrationformfield">
          <label for="field_registration">Show in Registration Form</label>
          <input type="checkbox" name="field_registration" id="field_registration" value="1" style="width:auto;" <?php if($row->registration==1)echo 'checked';?> />
        </p>
        <p id="visibilityfield">
          <label for="field_visibility">Visibility</label>
          <select type="checkbox" name="field_visibility" id="field_visibility">
            <option value="1" <?php if($row->Visibility==1)echo 'selected';?>>Public</option>
            <option value="2" <?php if($row->Visibility==2)echo 'selected';?>>Register</option>
            <option value="3" <?php if($row->Visibility==3)echo 'selected';?>>Private </option>
          </select>
        </p>
        <p id="orderingfield">
