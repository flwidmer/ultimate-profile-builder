...
if(isset($submit) && $submit==1 ) // Checks if the submit button is pressed or not
...
?>
      ...
      <div class="formtable">
        ...
        <div class="input-box">
          ...
          <div class="reg_frontErr" id="divinputPassword" style="display:none;">Please enter a password.</div>
...
<input type="checkbox" class="regular-text <?php echo $row1->Class;?>" 
				...
				<?php if($value!=""){if(in_array($radio,$array_value))echo 'checked';} ?> 
    ...
    <div class="UltimatePB-Button-area" >
      ...
      <input type="submit" value="Register" class="button button-primary button-large" id="submit" name="submit" onClick="return validateRegister()" >
